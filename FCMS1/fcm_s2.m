function [u,v,step_num] =fcm_s2(image_data,init_v,window_size,cluster_num,m,min_distance,alpha,max_step);
% the algorithm FCM_S2
...
image_filter = colfilt(image_data,[window_size window_size],'sliding',@filter2);   % row*col 
